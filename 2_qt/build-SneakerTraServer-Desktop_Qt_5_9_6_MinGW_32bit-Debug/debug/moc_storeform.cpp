/****************************************************************************
** Meta object code from reading C++ file 'storeform.h'
**
...
#include "../../SneakerTraServer/subwidgets/storeform.h"
#include <QtCore/qbytearray.h>
#include <QtCore/qmetatype.h>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'storeform.h' doesn't include <QObject>."
...
struct qt_meta_stringdata_StoreForm_t {
    QByteArrayData data[11];
    char stringdata0[197];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_StoreForm_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_StoreForm_t qt_meta_stringdata_StoreForm = {
    {
QT_MOC_LITERAL(0, 0, 9), // "StoreForm"
...
QT_MOC_LITERAL(10, 161, 35) // "on_cb_condition_currentIndexC..."
    ...
    "StoreForm\0on_pb_search_clicked\0\0"
...
static const uint qt_meta_data_StoreForm[] = {
...
void StoreForm::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        StoreForm *_t = static_cast<StoreForm *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
const QMetaObject StoreForm::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_StoreForm.data,
      qt_meta_data_StoreForm,  qt_static_metacall, nullptr, nullptr}
};


const QMetaObject *StoreForm::metaObject() const
{
    return QObject::d_ptr->metaObject ? QObject::d_ptr->dynamicMetaObject() : &staticMetaObject;
}

void *StoreForm::qt_metacast(const char *_clname)
{
    if (!_clname) return nullptr;
    if (!strcmp(_clname, qt_meta_stringdata_StoreForm.stringdata0))
        return static_cast<void*>(this);
    return QWidget::qt_metacast(_clname);
}

int StoreForm::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
