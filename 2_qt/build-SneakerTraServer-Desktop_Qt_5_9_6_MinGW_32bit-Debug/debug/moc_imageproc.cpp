...
QT_MOC_LITERAL(5, 44, 11), // "imagebuffer"
QT_MOC_LITERAL(6, 56, 21), // "signalSendMsgToClient"
QT_MOC_LITERAL(7, 78, 3) // "msg"

    },
    "ImageProc\0signalSendImgToClient\0\0id\0"
    "command\0imagebuffer\0signalSendMsgToClient\0"
    "msg"
};
...
void ImageProc::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->signalSendMsgToClient((*reinterpret_cast< QString(*)>(_a[1])),(*reinterpret_cast< QString(*)>(_a[2]))); break;
        default: ;
        }
        ...
        {
            typedef void (ImageProc::*_t)(QString , QString );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ImageProc::signalSendMsgToClient)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 1
void ImageProc::signalSendMsgToClient(QString _t1, QString _t2)
{
