...
public:
    ...
    void setupUi(QWidget *CLoginForm)
    {
        ...
        widget_login->setStyleSheet(QLatin1String("QLabel{\n"
...
"	background: transparent;\n"
"}"));
        gridLayout_2 = new QGridLayout(widget_login);
        gridLayout_2->setObjectName(QStringLiteral("gridLayout_2"));
        gridLayout = new QGridLayout();
        gridLayout->setObjectName(QStringLiteral("gridLayout"));
        pb_logup = new QPushButton(widget_login);
        ...
        le_id = new QLineEdit(widget_login);
        ...
        pb_forget = new QPushButton(widget_login);
        ...
        le_pswd = new QLineEdit(widget_login);
        ...
        pb_login = new QPushButton(widget_login);
        ...
        lb_top1 = new QLabel(widget_login);
...
"}"));
        ...
        lb_top0 = new QLabel(widget_login);
...
"}"));
    ...
    void retranslateUi(QWidget *CLoginForm)
    {
        ...
        lb_top1->setText(QApplication::translate("CLoginForm", "         SNEAKER | \345\220\276\351\236\213", Q_NULLPTR));
        lb_top0->setText(QApplication::translate("CLoginForm", "             \346\254\242   \350\277\216   \347\231\273   \351\231\206", Q_NULLPTR));
    } // retranslateUi
